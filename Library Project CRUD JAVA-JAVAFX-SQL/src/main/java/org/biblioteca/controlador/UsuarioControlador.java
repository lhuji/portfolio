...
public class UsuarioControlador {
    ...
    private void abrirVentanaMenu(String nombreUsuario) {
        try {
            ...
            stage.setTitle("Librería Luna Nueva");
            ...
            LibroControlador libroControlador = loader.getController();

            // Llama al nuevo método para establecer el nombre de usuario y luego inicializar
            libroControlador.inicializarConNombreUsuario(nombreUsuario);

            stage.setOnShown(event -> {
                libroControlador.llenarTablaConLibros();
            });
