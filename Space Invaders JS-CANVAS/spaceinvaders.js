...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Presiona 'espacio' para empezar a jugar.", game.width / 2, game.height/2); 
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textAlign="center"; 
    ctx.fillText("¡Has Perdido!", game.width / 2, game.height/2 - 40); 
    ctx.font="16px Arial";
    ctx.fillText("Tu puntuación fue de " + game.score + " y llegastes al nivel " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Presiona 'Espacio' para jugar de nuevo.", game.width / 2, game.height/2 + 40);   
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    info = "Puntuación: " + game.score + ", Nivel: " + game.level;
    ctx.textAlign = "right";
